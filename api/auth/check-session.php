...
if (isset($_SESSION['user_id'])) {
    ...
    // If user is admin, include additional user data (your existing code)
    if (($response['role'] ?? '') === 'admin') {
        ...
        try {
            ...
            // Add users data to response for admin
            $response['users'] = $users;
            
        } catch (Throwable $e) {
            // If database query fails, still return authenticated status
            $response['database_error'] = 'Failed to load users data';
